        ...
        <div className="sticky top-4 space-y-3 z-10">
          <div className="rounded-lg border border-border/50 bg-card/50 overflow-hidden">
            ...
            <div className="px-4 py-3 bg-secondary/30 border-b border-border/50">
              <h3 className="text-base font-semibold">Market Input Setup</h3>
              <p className="text-sm text-muted-foreground mt-0.5">Configure each stage</p>
            </div>
            ...
            <div className="px-4 py-3 border-t border-border/50 bg-secondary/20">
              <div className="flex items-center justify-between text-sm font-medium text-muted-foreground mb-2">
                <span>Progress</span>
                <span className="text-foreground">{currentTabIndex + 1} of {TABS.length}</span>
              </div>
