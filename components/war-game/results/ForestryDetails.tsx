...
export function ForestryDetails({ result }: ForestryDetailsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card id="forestry-ai-analysis" className="border-2 border-green-200 bg-gradient-to-r from-green-50/50 to-emerald-50/50 scroll-mt-72">
      ...
      <Card id="forestry-woodchip-supply" className="border-border/50 bg-card/80 scroll-mt-72">
        <CardHeader className="pb-2">
      ...
      <Card id="forestry-import-dependency" className="border-border/50 bg-card/80 scroll-mt-72">
        <CardHeader className="pb-2">
          <CardTitle className="text-sm flex items-center gap-2">
            <Ship className="h-4 w-4 text-blue-600" />
      ...
      <Card id="forestry-supply-demand" className="border-border/50 bg-card/80 scroll-mt-72">
        <CardHeader className="pb-2">
          <CardTitle className="text-sm flex items-center gap-2">
