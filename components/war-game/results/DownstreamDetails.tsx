...
export function DownstreamDetails({ result }: DownstreamDetailsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div id="downstream-health-overview" className="rounded-xl border-2 border-purple-200 bg-gradient-to-r from-purple-50 via-pink-50 to-purple-50 p-4 scroll-mt-72">
      ...
      {/* Paper Market */}
      <div id="downstream-paper" className="scroll-mt-72">
        <DownstreamTable
          segmentKey="paper"
      ...
      <div id="downstream-board" className="scroll-mt-72">
        <DownstreamTable
          segmentKey="board"
      ...
      {/* Tissue Market */}
      <div id="downstream-tissue" className="scroll-mt-72">
        <DownstreamTable
          segmentKey="tissue"
