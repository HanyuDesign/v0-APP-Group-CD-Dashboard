...
export function PulpCapacityDetails({ result }: PulpCapacityDetailsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div id="pulp-value-chain-flow" className="rounded-xl border-2 border-blue-200 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 p-4 scroll-mt-44">
      ...
      <Card id="pulp-app-capacity" className="border-2 border-red-200 bg-red-50/30 scroll-mt-44">
      ...
      <Card id="pulp-competitor-response" className="border-border/50 bg-card/80 scroll-mt-44">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm flex items-center gap-2">
      ...
      <Card id="pulp-export-reallocation" className="border-border/50 bg-card/80 scroll-mt-44">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm flex items-center gap-2">
      ...
      <Card id="pulp-market-impact" className="border-border/50 bg-blue-50/30 scroll-mt-44">
        <CardHeader className="pb-2">
